...
LibGameDistribution.StartCallback = function()
{
    if (AdsService.instance !== undefined)
    {
        var self = AdsService.instance.service;
...
LibGameDistribution.PauseCallback = function()
{
    if (AdsService.instance !== undefined)
    {
        var self = AdsService.instance.service;
...
LibGameDistribution.ErrorCallback = function()
{
    if (AdsService.instance !== undefined)
    {
        var self = AdsService.instance.service;
...
LibGameDistribution.SDKErrorCallback = function()
{
